...
class ThemeCore {
	...
	public function i18n() {
		load_theme_textdomain( 'blank-brand-theme', BLANK_BRAND_THEME_PATH . '/languages' );
	}
	...
	public function theme_setup() {
		...
		register_nav_menus(
			array(
				'primary' => esc_html__( 'Primary Menu', 'blank-brand-theme' ),
				'footer' => esc_html__( 'Footer Menu', 'blank-brand-theme' ),
			)
		);
	}
	...
	public function init() {
		...
		ModuleInitialization::instance()->init_classes( BLANK_BRAND_THEME_INC );
